<?php 
	...
	// COLUMN
	$columnPost		= $this->arrParam['filter_column'] ?? null;
	$orderPost		= $this->arrParam['filter_column_dir'] ?? null;
	...
	$selectboxStatus	= Helper::cmsSelectbox('filter_state', 'inputbox', $arrStatus, $this->arrParam['filter_state'] ?? null);
	
	// SELECT SPECIAL
	$arrSpecial			= array('default' => '- Select Special -', 1 => 'Yes',  0 => 'No');
	$selectboxSpecial	= Helper::cmsSelectbox('filter_special', 'inputbox', $arrSpecial, $this->arrParam['filter_special'] ?? null);
	
	// CATEGORY
	$selectboxCategory	= Helper::cmsSelectbox('filter_category_id', 'inputbox', $this->slbCategory, $this->arrParam['filter_category_id'] ?? null);
				...
				<form action="#" method="post" name="adminForm" id="adminForm">
                    ...
                    <fieldset id="filter-bar">
                        <div class="filter-search fltlft">
                            ...
                            <input type="text" name="filter_search" id="filter_search" value="<?php echo $this->arrParam['filter_search'] ?? null;?>">
