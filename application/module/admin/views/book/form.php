<?php 
	...
	// Input
	$dataForm 			= $this->arrParam['form'] ?? null;
	...
	if(isset($this->arrParam['id']) || $dataForm['id']){
		...
		$inputUserName	= Helper::cmsInput('text', 'form[username]', 'username', @$dataForm['username'] ?? null, 'inputbox readonly', 40);
...
?>
<div id="system-message-container"><?php echo $strMessage . ($this->errors ?? null);?></div>
<div id="element-box">
	<div class="m">
